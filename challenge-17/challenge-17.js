(function(){
    ...
    */
    ...
    console.log(text.replace(/manuel marques de sousa/i, 'Caio Cesar de Freitas Santos'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/gi, 'paulistano'));
    ...
    */
    ...
    console.log('O nome do mês março é representado pelo número: ' + getMonthNumber('março'));
    console.log('O nome do mês setembro é representado pelo número: ' + getMonthNumber('setembro'));
    console.log('O nome do mês dezembro é representado pelo número: ' + getMonthNumber('dezembro'));

    /*
    Alternativa com objeto
